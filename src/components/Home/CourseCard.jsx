...
export default function CourseCard({ course }) {
  ...
  return (
    <Link
      href={course.link || "#"}
      className="block h-full bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group"
    >
      {/* Badge */}
      {course.badge && (
      ...
      <div className="p-8 pt-16 h-full flex flex-col">
        ...
        {/* Star Rating */}
        <div className="flex items-center gap-1 mb-6">{renderStars()}</div>

        {/* Description */}
        <p className="text-gray-600 leading-relaxed mb-6 min-h-[96px] line-clamp-4 flex-grow">
          {course.description ||
            "Enhance your skills with our comprehensive training program designed by industry experts."}
        </p>
