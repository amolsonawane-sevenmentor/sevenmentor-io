...
const HomePopUpForm = ({ isOpen, onClose, title, mailId, contactNo, bannerTitle, mailSubject, userEmailSubject }) => {
          ...
          <div className="flex-1 overflow-y-auto p-6">
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={formik.handleSubmit} className="space-y-4">
                ...
                {/* Course Name Field */}
                <div className="relative">
                  <FontAwesomeIcon icon={faBook} className="absolute top-4 left-3 text-gray-600 z-10" />
                  <input
                    type="text"
                    name="CourseName"
                  ...
                  {formik.touched.CourseName && formik.errors.CourseName && (
                    <div className="text-red-700 text-sm mt-1">{formik.errors.CourseName}</div>
                  )}
                </div>
