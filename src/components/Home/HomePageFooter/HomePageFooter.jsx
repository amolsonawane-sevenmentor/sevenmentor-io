...
import "../AboveFooterForm/AboveFooterForm.css";
// import HomePageForm from "../../Forms/HomePageForm.jsx";
import Image from "next/image";
import dynamic from "next/dynamic";
const  HomePageForm =dynamic(()=>import("../../Forms/HomePageForm.jsx"), {srr:false})


// Forward ref to target the form inside this component
const HomePageFooter = forwardRef(({ mailId, contactNo, bannerTitle }, ref) => {
  ...
  return (
    ...
    <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(251,146,60,0.15),transparent_25%)]" />
      ...
      <div className="container relative mx-auto grid h-full min-h-[600px] grid-cols-1 gap-12 lg:px-24 py-16 lg:grid-cols-2">
        ...
        <div ref={ref}>
          <HomePageForm mailId={mailId} contactNo={contactNo} bannerTitle={bannerTitle} />
        </div>
      </div>
    </section>
    </div>
