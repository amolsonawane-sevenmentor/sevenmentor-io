    ...
    { name: "Contact", link: "/contact-us" },
    {
      ...
      submenu: [
        ...
        { name: "CHFI Course", link: "/chfi-course-in-mumbai" },
        {
          ...
          link: "/cyber-security-course-in-mumbai",
        },
        {
          name: "Ethical Hacking",
          link: "/ethical-hacking-training-in-mumbai",
        },
        {
          name: "Security Operations Center Course",
          link: "/security-operations-center-course-in-mumbai",
        },

        { name: "WAPT Course", link: "/wapt-course-in-mumbai" },
        {
          name: "Cyber Security Analyst Course",
          link: "/cyber-security-analyst-course-in-mumbai",
        },
      ],
    },
  ];
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link href="/" className="flex-shrink-0 flex items-center gap-0">
            ...
            <div className="relative">
              ...
              <span className="absolute -bottom-2 right-0 text-[10px] text-gray-500 font-bold tracking-widest">
                PVT. LTD.
              </span>
            </div>
          </Link>
              ...
              >
                <Link
                  ...
                  className={`
                                        ...
                                        ${
                                          item.submenu
                                            ? "group-hover:bg-[#009bf5] group-hover:text-white"
                                            : ""
                                        }
                                    `}
                >
