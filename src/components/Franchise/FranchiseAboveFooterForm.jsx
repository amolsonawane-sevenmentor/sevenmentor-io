...
export default function FranchiseAboveFooterForm({
  emailRoute,
  mailId,
  contactNo,
  bannerTitle,
  ...
  return (
    <div className="p-4 w-full flex items-center justify-center">
      <div className="w-full text-center">
        <h3 className="text-orange-500 text-center font-semibold mb-6 text-2xl md:text-4xl">
        ...
        >
          <Formik initialValues={initialValues} validationSchema={franchiseSchema} onSubmit={handleSubmit}>
                ...
                <div className="lg:pl-[20px] pl-[33px]">
                  ...
                  >
                    ...
                    <Image
                      ...
                      width={44}
                      height={48}
                      className="absolute top-0 left-0 shimmer-effect w-[44px] h-[48px]"
                      style={{
                        objectFit: "cover",
                        height: "100%",
                      }}
