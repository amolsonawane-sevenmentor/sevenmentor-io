...
// import "../Home/AboveFooterForm/AboveFooterForm.css";
import FranchiseAboveFooterForm from "./FranchiseAboveFooterForm.jsx";
import Image from "next/image";
// Forward ref to target the form inside this component
const FranchiseAboveFooter = forwardRef(({ emailRoute, mailId, contactNo, bannerTitle, mailSubject, userEmailSubject, formTitle }, ref) => {
  ...
  const features = [
    ...
    {
      image: "/assets/WhyChoose/stand_out_with_an_impressive_certificate.webp", // Replace with actual image path
  ...
  return (
    ...
    <section className="relative min-h-[600px] w-full overflow-hidden bg-gradient-to-br from-black via-black/95 to-orange-900/100">
    {/* Decorative Elements */}
    <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(251,146,60,0.15),transparent_25%)]" />
      ...
      <div className="container relative mx-auto grid h-full min-h-[600px] grid-cols-1 gap-12 lg:px-24 py-16 lg:grid-cols-2">
        ...
        >
          <div className="space-y-4">
            ...
            <p className="max-w-[600px] text-lg text-gray-400">
              Investing in the right skills at the right place paves the way for
              long-term career success and growth. SevenMentor Institute equips
              you with industry-relevant expertise, ensuring you stay ahead in
          ...
          <div {...fadeIn} className="flex items-center justify-center space-x-4">
        ...
        <div ref={ref}>
          <FranchiseAboveFooterForm mailId={mailId} contactNo={contactNo} bannerTitle={bannerTitle} mailSubject={mailSubject} userEmailSubject={userEmailSubject} formTitle={formTitle}  emailRoute={emailRoute} />
        </div>
      </div>
    </section>
    </div>
...
// Add display name for better debugging in Next.js
FranchiseAboveFooter.displayName = 'FranchiseAboveFooter';

export default FranchiseAboveFooter;