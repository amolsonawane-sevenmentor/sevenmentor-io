...
export default function EventForm({event}) {
  ...
  const [userIP, setUserIP] = useState(""); // State to store the IP Address
  ...
  // const mailId = "eventleads@sevenmentor.com";
  const mailId = "registration@sevenmentor.com";
    ...
    try {
      ...
      const response = await axios.post(
        "/api/event-form",
        {
          ...
          mailSubject: "New Event Registration Request Received",
          userEmailSubject: "Thank You for your Registration -- SevenMentor",
        },
        { timeout: 10000 }
      );
    ...
    <div className="p-4 pb-0 flex items-center justify-center rounded-xl">
      <div className="w-full max-w-md text-center">
        <h3 className="text-white font-bold mb-3 text-2xl md:text-3xl">
          Get Free{" "}
          <span className="text-orange-500 !text-3xl !tracking-tight">
            Consultation
          </span>
        </h3>
          ...
          >
            {({ errors, touched, values, isSubmitting }) => (
              <Form className="space-y-4">
                ...
                {/* City Field */}
                <div className="relative pl-[40px]">
                  <MapPin className="absolute left-0 top-1/2 -translate-y-1/2 h-8 w-8 text-orange-500" />
                  <div className="relative">
                    <Field
                      name="city"
                      aria-label="City"
                ...
                {/* Profession Field */}
                <div className="relative pl-[40px]">
                  <Briefcase className="absolute left-0 top-1/2 -translate-y-1/2 h-8 w-8 text-orange-500" />
                  <div className="relative">
                    <Field
                      name="profession"
                ...
                <div className="lg:pl-[20px] pl-[33px]">
                  <button
                    type="submit"
                    className="cursor-pointer relative w-full mt-2 lg:w-[250px] bg-gradient-to-r from-orange-700 to-orange-500 text-white font-bold py-3 px-4 rounded-full overflow-hidden"
