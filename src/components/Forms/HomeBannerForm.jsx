...
import { User, Mail, Phone, Pin, Map, ChevronDown, X, CheckCircle } from "lucide-react"
      ...
      {showPopup && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
          <div className="bg-white p-8 rounded-2xl shadow-2xl max-w-sm w-full text-center relative">
            {/* Updated popup content to match the image with success/error states */}
            <div className="flex flex-col items-center justify-center space-y-4">
              ...
              <h3
                className={`text-2xl font-bold ${popupMessage.includes("received") ? "text-gray-800" : "text-red-600"}`}
              >
