...
import { User, Phone, Mail, CheckCircle, AlertCircle, Map } from "lucide-react"
...
export default function ReviewForm(email) {
    ...
    try {
      ...
      const response = await axios.post(
        "/api/main-form",
        {
          ...
          token,
          to: mailId,
          mailSubject: "New Free Consultation Request Received",
          userEmailSubject: "Thank You For Requesting a Consultation From SevenMentor",
  ...
  return (
    <div className="p-4 pb-0 flex items-center justify-center rounded-xl z-10">
            ...
            {({ errors, touched, values, isSubmitting }) => (
              <Form className="space-y-4">
                ...
                <div className="lg:pl-[20px] pl-[33px]">
                  <button
                    type="submit"
                    className="relative w-full mt-2 lg:w-[250px] bg-gradient-to-r from-orange-700 to-orange-500 text-white font-bold py-3 px-4 rounded-full overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed"
