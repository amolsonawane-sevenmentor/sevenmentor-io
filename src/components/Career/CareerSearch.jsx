...
const CareerSearch = ({ searchQuery, onSearchChange, onClearSearch }) => {
    ...
    <div className="w-full max-w-2xl mx-auto mb-8 px-6">
      <div className="relative" ref={searchRef}>
        ...
        <input
          ...
          className="w-full py-3 pl-10 pr-20 text-gray-700 bg-white border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
        />
          ...
          <div className="absolute top-1/2 left-10 transform -translate-y-1/2 text-gray-400 pointer-events-none">
            <TypeAnimation
              sequence={[
                ...
                1500,
                "Search for Marketing positions...",
                1500,
                "Search for Full-Time careers...",
                1500,
                "Search for Remote opportunities...",
                1500,
                "Search for jobs in Pune...",
                1500,
              ]}
              wrapper="span"
              speed={50}
      ...
      <div className="flex items-center justify-between mt-2">
        ...
        {isListening && <p className="text-sm text-orange-500 font-medium animate-pulse">🎤 Listening...</p>}

        {!isSpeechSupported && <p className="text-xs text-gray-500">Voice search not supported in this browser</p>}
      </div>
    </div>
  )
}
