...
function Fashion() {
  ...
  return (
    <>
      ...
      <DesignBanner imagePath={"/assets/bannerImages/fashionBanner.webp"} altText="Fashion Design Banner" contactNo={"02071173070 "} />
      ...
      {showLazyComponents && (
        <>
          ...
          <NonITCourseContent courseName={selectedDomain} />
          <NonITFaqs faqData={faqData.fashionDesign} />
          ...
          <StickyButton mailId={"cad@sevenmentor.com"} contactNo={"02071173070"} bannerTitle={"Fashion Design Course"} />
        </>
      )}
    </>
  )
