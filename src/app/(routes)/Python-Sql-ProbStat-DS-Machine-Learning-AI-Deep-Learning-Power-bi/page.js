...
export default function WAPTCoursePage() {
    ...
    const heroData = {
        title: 'Python, SQL, Statistics, Data Science, AI & Power BI Course in Mumbai',
        subtitle: 'Master Python, SQL, Probability & Statistics, Machine Learning, Deep Learning & Power BI',
        description: `
            Become a job-ready Data Analyst and Data Scientist with Mumbai’s most comprehensive 
            Python + SQL + Probability & Statistics + Data Science (Machine Learning) + 
            AI (Deep Learning) + Power BI course. 
            Learn end-to-end data analytics and data science skills through hands-on projects, 
            real industry datasets, business case studies, dashboards, and model-building. 
            Master in-demand tools such as Python, MySQL, Pandas, NumPy, Scikit-Learn, TensorFlow, 
            and Power BI with guidance from expert trainers at SevenMentor.
        `,
        badges: [
            { icon: Clock, label: '150+ Hours Advanced Training', color: 'bg-orange-600' },
            { icon: Users, label: '12,000+ Learners in Mumbai', color: 'bg-blue-600' },
            { icon: Award, label: 'Industry & ISO-Certified Program', color: 'bg-orange-600' },
            { icon: Briefcase, label: '100% Placement Assistance', color: 'bg-purple-600' }
        ]
    };
    ...
    const aboutCourse = {
        title: 'About Python + SQL + DS & AI Training in Mumbai',
        description: `
            This advanced Data Analytics and Data Science course in Mumbai teaches Python, SQL, Probability & Statistics, Machine Learning, Deep Learning, and Power BI in a single program. 
            Students gain hands-on experience with real-world datasets, predictive modeling, dashboard creation, and statistical analysis. 
            SevenMentor’s Mumbai-based program equips learners with industry-ready skills for roles like Data Analyst, Data Scientist, BI Developer, and AI Specialist.
        `,
        highlights: [
            'Expert Trainers with 10+ Years Industry Experience in Analytics, ML & AI',
            'Hands-on Projects with Real Business Data',
            'Python, SQL, Probability & Statistics, ML, AI & Power BI Training',
            'Flexible Weekday, Weekend & Fast-Track Batches in Mumbai',
            '100% Placement Assistance with Resume & Interview Preparation',
            'Industry-Recognized Certification with Job-Ready Skills'
        ],
        sections: [
            {
                heading: 'What is Data Analytics & Data Science?',
                content: `
                    Data Analytics involves analyzing raw data to extract actionable insights, 
                    while Data Science extends analytics by applying Machine Learning and AI for predictive modeling. 
                    Students learn Python, SQL, Power BI, and Statistics to clean, visualize, and interpret data. 
                    This course covers everything from basic Excel to advanced Deep Learning models, 
                    preparing you for analytics and AI-driven roles across industries in Mumbai.
                `
            },
            {
                heading: 'Why is this Training Important?',
                content: `
                    Mumbai is a hub for IT, finance, healthcare, and analytics-driven companies. 
                    Businesses demand professionals skilled in Python, SQL, ML, AI, and Power BI to make data-driven decisions. 
                    By learning these skills, you can solve complex business problems, improve operational efficiency, 
                    and unlock high-paying career opportunities as Data Analysts, BI Developers, or Data Scientists.
                `
            },
            {
                heading: 'What Does a Data Analytics/DS Professional Do?',
                content: `
                    Data professionals collect, clean, analyze, visualize, and model data to provide business insights. 
                    They create dashboards, reports, predictive models, and AI algorithms to optimize processes and improve decisions. 
                    Tools used include Python for programming, SQL for data querying, Power BI for visualization, and ML/AI frameworks for predictive analytics.
                `
            },
            {
                heading: 'Why Choose SevenMentor for this Training in Mumbai?',
                content: `
                    SevenMentor has trained over 10,000 learners in analytics, ML, and AI across India. 
                    Trainers have real industry experience and provide hands-on projects using real business datasets. 
                    Students learn end-to-end skills in Python, SQL, Probability & Statistics, Machine Learning, Deep Learning, and Power BI. 
                    Flexible batches, placement assistance, and industry-recognized certification make this one of Mumbai’s most comprehensive career-oriented data courses.
                `
            }
        ]
    };
    ...
    const syllabus = {
        modules: [
            {
                id: 1,
                title: 'Introduction to Data Analytics & Data Science',
                duration: '1 Week',
                topics: [
                    'Overview of Data Analytics & Data Science',
                    'Applications of Data Science in Business',
                    'Role of a Data Analyst and Data Scientist',
                    'Understanding Business Problems and KPIs',
                    'Data Lifecycle and Analytics Process',
                    'Key Tools: Python, SQL, Power BI, Excel',
                    'Career Opportunities in Analytics and AI'
                ]
            },
            {
                id: 2,
            ...
            {
                id: 3,
                title: 'Probability & Statistics for Analytics',
                duration: '2 Weeks',
                topics: [
            ...
            },
            {
                ...
                topics: [
                    ...
                    'Business Case Study SQL Queries'
                ]
            },
            {
                id: 5,
            ...
            },
            {
                ...
                topics: [
                    ...
                    'Visual EDA with Python and Seaborn',
                    'Identifying Patterns, Trends & Insights'
                ]
            },
            {
                id: 7,
                ...
                topics: [
                    ...
                    'Publishing, Sharing & Row-Level Security'
                ]
            },
            {
                id: 8,
                ...
                topics: [
                    ...
                    'Hands-on ML Projects with Python'
                ]
            },
            {
                id: 9,
                title: 'Deep Learning & AI Concepts',
                duration: '3 Weeks',
                topics: [
                    ...
                    'AI Project Implementation & Case Studies'
                ]
            },
            {
                id: 10,
            ...
            },
            {
                ...
                topics: [
                    ...
                    'Creating Interactive Dashboards',
                    'Storytelling with Data & Publishing Reports'
                ]
            },
            {
                id: 12,
                title: 'Big Data Concepts & Cloud Analytics',
                duration: '2 Weeks',
                topics: [
                    'Overview of Big Data Ecosystem',
                    'Introduction to Hadoop & Spark',
                    'Distributed Data Processing Concepts',
                    'Cloud Platforms: AWS, Azure & Google Cloud Analytics'
                ]
            },
            {
                id: 13,
                ...
                duration: '3 Weeks',
                topics: [
                    'Sales and Marketing Analytics Case Study',
            ...
            {
                id: 14,
                title: 'Analytics Automation & Deployment',
                duration: '2 Weeks',
                topics: [
                    'Automating Reports using Python & Power BI',
                    'Data Refresh Scheduling & Pipelines',
            ...
            },
            {
                ...
                topics: [
                    ...
                    'Color Theory and Visualization Best Practices',
